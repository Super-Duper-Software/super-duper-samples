// The "Filters ▾" trigger and its anchored panel, shared by the search
// `FilterBar` (ticket 15) and the Library `LibraryFilterBar` (ticket 13).
//
// Presentation only. The caller passes the filter controls as `children` and
// owns every piece of filter state; this component only opens/closes the panel
// (outside-click and Escape close it, matching `CollectionMenu`) and shows how
// many constraints are active as a badge on the trigger.
