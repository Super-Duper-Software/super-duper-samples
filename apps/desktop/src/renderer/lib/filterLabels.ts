// Pure presentation helpers for the ticket-15 filter bar: the option lists the
// dropdowns render, and the derivation of a `SearchFilter` into human-readable
// chips (also reused for the "which filter to relax" empty-results hint). No
// React, no I/O — trivially eyeballed.
