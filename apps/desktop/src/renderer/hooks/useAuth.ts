// Reads auth state from the core and keeps it live. Presentation only — every
// decision (what "signed in" means, when to refresh, what a failed refresh does)
// is in the core; this hook just mirrors `getAuthState()` and the push channel.
