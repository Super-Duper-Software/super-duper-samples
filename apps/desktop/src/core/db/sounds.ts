// `sounds` table access. Metadata from every search response is persisted here so
// tickets 08/11/12 have it without re-fetching. The upsert and the ordered
// by-ids read are both reused by later tickets.
