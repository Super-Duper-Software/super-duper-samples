...
- **macOS builds carry an ad-hoc signature** (`codesign --sign -`, applied in the
  ...
  prompt, which `marketing/first-run.md` walks through (System Settings →
...
The ticket's acceptance criteria are rewritten to this reduced scope in
`.scratch/freesound-desktop-v1/issues/19-package-sign-notarize-update.md`.
